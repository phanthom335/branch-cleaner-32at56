        """
        Branch Cleaner 32at56
        =====================
        GitHub Actions-compatible script to monitor repository housekeeping tasks.
        ...
        APP_NAME    = "Branch Cleaner 32at56"
        APP_VERSION = "1.0.0"
...
def _step_report(config, report):   pass  # TODO
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="GitHub Actions-compatible script to monitor repository housekeeping tasks.")
